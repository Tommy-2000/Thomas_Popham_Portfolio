...
class BlogPostHeroCardPost1 extends StatefulWidget {
  ...
  @override
  State<BlogPostHeroCardPost1> createState() => _BlogPostHeroCardPost1State();
}

class _BlogPostHeroCardPost1State extends State<BlogPostHeroCardPost1> {
